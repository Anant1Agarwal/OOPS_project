...
String idString = fullList.get(i).getId();
int minValue = idString.isEmpty() ? 0 : Integer.valueOf(idString);
            ...
            for (Cart c : fullList) {
                ...
                } else if (Integer.valueOf(c.getId()) < Integer.valueOf(customerID))
                {
                    right = mid - 1;
                } else {
                    left = mid + 1;
